...
/// <summary>
/// A class for Load Assembly from Embedded Resources into memory
/// </summary>
public class EmbeddedAssembly
{
    ...
    /// <summary>
    /// Load Assembly from Embedded Resources into memory in Method Main from Class Program
    /// Example Usage: EmbeddedAssembly.Load(namespace.FileName);
    /// </summary>
    ...
    {
        // Find the index of the first period (.) in the input string
        int index = embeddedResource.IndexOf('.');
        
        // Extract the substrings using the index of the first period
        string fileName = embeddedResource.Substring(index + 1);
    
        // Load Assembly
        AssemblyLoad(embeddedResource, fileName);
    }
    ...
    public static void AssemblyLoad(string embeddedResource, string fileName)
    {
        if (dic == null)
